...
mergeddata <- reshape2::dcast(data = mergeddata, formula = SubjectNumber + Activity ~ variable, fun.aggregate = mean)
write.table(mergeddata, file = "tidyData.txt", row.names = FALSE)
